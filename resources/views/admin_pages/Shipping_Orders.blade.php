    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('public.Orders')</li>
            </ol>

        </nav>
        <nav style="width: 300px;">
            <form action="/admin/shipping/orders/filter" method="get" style="display: flex;">
                <select class="form-control" name="quary">
                    <option value="">@lang('public.Shipping_Statue')</option>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body table-responsive">
                        <h5 class="card-title">@lang('public.Shipping_Data')</h5>
                        ...
                        <table class="table datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">@lang('public.Customer_Email')</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ url('admin/show/shipping/details', ['encrypted_id' => Crypt::encryptString($item->id)]) }}">{{$item->email}}</a></td>
