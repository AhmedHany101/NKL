...
<main id="main">
    ...
    <div class="breadcrumbs">
        <div class="page-header d-flex align-items-center" style="background-image: url({{asset('/public_user_front/assets/img/page-header.jpg')}});">
            <div class="container position-relative">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-6 text-center">
                        <h2>@lang('public.User_Profile')</h2>
                        @if (app()->getLocale() === 'ar')
                        <p>مرحبًا بك في ملف تعريف المستخدم الخاص بك! هنا، يمكنك إدارة إعدادات حسابك وتتبع شحناتك والوصول إلى حلول الشحن المخصصة</p>
                        @else
                        <p>Welcome to your user profile! Here, you can manage your account settings, track your shipments, and access personalized shipping solutions.</p>
                        @endif
    ...
    <section class="container">
        <div class="row div">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#900C3F" class="bi bi-person-gear img" viewBox="0 0 16 16">
            ...
            <div>
                <h5>@lang('public.My_Shipping_Information')</h5>
                            ...
                            <tr>
                                <th scope="row">
                                    <a href="/my/order/information/{{$encrypted_id}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#900C3F" class="bi bi-eye-fill" viewBox="0 0 16 16">
