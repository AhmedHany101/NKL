...
<main id="main">
    <section id="contact" class="contact">
        <div class="container con" data-aos="fade-up">
            <div class="login-box">
                <h2>@lang('public.Register')</h2>
                <form action="{{route('registertion')}}" method="post" id="signup-form">
                    @if(session('message2'))
                    <div style="color:#CFD632;">{{session('message2')}}</div>
                    @endif
                    @csrf
                    <div class="user-box">
...
<a href="{{url('signin')}}" style="color: white;">
                @lang('public.Login')
                </a>
                </form>
